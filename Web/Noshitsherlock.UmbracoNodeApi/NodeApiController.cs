...
using Noshitsherlock.UmbracoNodeApi.Models;
using umbraco;
...
namespace Noshitsherlock.UmbracoNodeApi
{
    ...
    public class NodeApiController : UmbracoApiController
    {
        ...
        public HttpResponseMessage GetNodesByDocumentTypeAlias(string documentTypeAlias)
        {
        ...
        /// /umbraco/api/nodeapi/getnodebyurl?url=/about
        /// </summary>
